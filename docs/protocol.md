...
Офіційний застосунок пише команду у FFE9 як ATT Write Command. HCI capture підтвердив три допустимі значення:

| Потужність | Payload у FFE9 |
|---:|---|
| 400 W | `10 01 00 01 00 04 16 31 00 00 00 00 00 00 00 00 00 91 00 00` |
| 800 W | `10 01 00 01 00 04 16 31 00 00 00 00 00 00 00 00 00 23 00 00` |
| 1200 W | `10 01 00 01 00 04 16 31 00 00 00 00 00 00 00 00 00 b4 00 00` |

Після запису офіційний застосунок отримує коротке підтвердження з кодом `16 32`.
