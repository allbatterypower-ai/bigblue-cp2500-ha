...
SENSORS = [
    ...
    SensorDef("ac_input_power", "AC Input Power", UnitOfPower.WATT, SensorDeviceClass.POWER, 0),
    SensorDef("ac_input_voltage", "AC Input Voltage", UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, 1),
    SensorDef("ac_input_current", "AC Input Current", UnitOfElectricCurrent.AMPERE, SensorDeviceClass.CURRENT, 1),
    SensorDef("ac_input_frequency", "AC Input Frequency", "Hz", SensorDeviceClass.FREQUENCY, 2),
    SensorDef("dc_output_power", "DC Output Power", UnitOfPower.WATT, SensorDeviceClass.POWER, 0),
    SensorDef("dc_output_voltage", "DC Output Voltage", UnitOfElectricPotential.VOLT, SensorDeviceClass.VOLTAGE, 1),
    SensorDef("dc_output_current", "DC Output Current", UnitOfElectricCurrent.AMPERE, SensorDeviceClass.CURRENT, 1),
