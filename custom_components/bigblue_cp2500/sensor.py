...
SENSORS = [
    ...
    SensorDef("aux_temperature_1", "Aux Temperature 1", UnitOfTemperature.CELSIUS, SensorDeviceClass.TEMPERATURE, 1),
    SensorDef("aux_temperature_2", "Aux Temperature 2", UnitOfTemperature.CELSIUS, SensorDeviceClass.TEMPERATURE, 1),
